...
export function CardHeader({ className, children, ...props }: CardHeaderProps) {
  return (
    <div
      className={cn("flex flex-col space-y-1.5 border-b border-neutral-800 p-6", className)}
      {...props}
    >
      {children}
    </div>
...
export function CardFooter({ className, children, ...props }: CardFooterProps) {
  return (
    <div
      className={cn("flex items-center border-t border-neutral-800 p-6 pt-0", className)}
      {...props}
    >
      {children}
    </div>
